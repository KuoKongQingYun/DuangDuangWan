    ...
    <div class="register">
        <div class="am-g am-container am-margin-vertical-lg">
            <div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                <form action="action" method="POST" role="form" class="am-form">
                    ...
                    <div class="am-form-group">
                        <label for="">登陆邮箱：</label><span class="am-text-warning"><?php echo ($emailWarning); ?></span>
                        <input type="text" id="" placeholder="请输入您的邮箱" name="email">
                        <label for="">登陆密码：</label><span class="am-text-warning"><?php echo ($passwordWarning); ?></span>
                        <input type="password" id="" placeholder="请输入您的密码" name="password">
                        <label for="">确认密码：</label><span class="am-text-warning"><?php echo ($password2Warning); ?></span>
                        <input type="password" id="" placeholder="确认您的密码" name="password2">
                    </div>
            ...
            <div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                ...
                <p>注册用户，您可以上传你自己的项目，或者给别人的项目提供后期处理后的视频。</p>
            </div>
        </div>
    </div>
    <footer class="footer">
